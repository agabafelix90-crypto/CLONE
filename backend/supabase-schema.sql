...
CREATE TABLE expenses (
  ...
  details TEXT,
  reason TEXT,
  payment_method TEXT CHECK (payment_method IN ('cash', 'card', 'mobile', 'transfer', 'cheque', 'other')),
  status TEXT DEFAULT 'posted' CHECK (status IN ('posted', 'pending', 'reconciled', 'cancelled')),
  shift TEXT,
  taken_by TEXT,
  served_by TEXT,
  date DATE NOT NULL DEFAULT CURRENT_DATE,
